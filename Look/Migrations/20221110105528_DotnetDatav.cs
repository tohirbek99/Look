...
{
    public partial class DotnetDatav : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippedData = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmployeeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Details_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_Details_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_Details_OrderId",
                table: "Orders_Details",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_Details_ProductId",
                table: "Orders_Details",
                column: "ProductId");
