...
namespace Look.DBContexts.TagHelpers
{
    public class PaginationTagHelper : TagHelper
    {
        ...
        private void ClosingHtml(StringBuilder content)
        {
            ...
            {
                content.Append($"<li class='page-item'><a class='page-link' href='{PageTarget}?p={PageNumber + 1}'>{PageNext}</a></li>");
        ...
        private void InitPaginationHtml(StringBuilder content)
        {
            ...
            if (PageNumber != 1)
            {
                ...
                content.Append($"<li class='page-item'><a class='page-link' href='{PageTarget}?p={PageNumber - 1}'>{PagePrevious}</a></li>");
